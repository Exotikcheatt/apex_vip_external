...
#define code_rw CTL_CODE(FILE_DEVICE_UNKNOWN, 0x798541, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define code_ba CTL_CODE(FILE_DEVICE_UNKNOWN, 0x798542, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define code_get_guarded_region CTL_CODE(FILE_DEVICE_UNKNOWN, 0x798543, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
namespace mem {
	...
	bool find_driver() {
		SPOOF_FUNC;
		driver_handle = CreateFileW((L"\\\\.\\\9898710"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL);
